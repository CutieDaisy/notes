...
# Bridge 2
docker run --restart always -v /etc/hosts:/etc/hosts --name papss-bridge2-06112024 -p 7221:7221 -p 10500:7221 -v /opt/papss-bridge2/logs/:/logs/ -e DB_HOST=172.18.253.91 -e PAPSS_BRIDGE1_CCY=LRD -e PAPSS_BRIDGE1_COUNTRY=LR -e PAPSS_ID=LR100012 -e PAPSS_SWIFT_CODE=ACLILRLM -e CORE_BANKING_BASE_URL=https://papi.accessbank.com.lr/ -e LDAP_URL=ldap://172.18.1.3:389 -e LDAP_USE=true -e LDAP_API_KEY= -e LDAP_APP_ID= -e 2FA_ENABLED=false -e LDAP_USERNAME_PREFIX=ACCESSBANK -e CORE_BANKING_PASS=%%Ablp@2024^^ -e PAPSS_BRIDGE1_BASE=http://172.17.0.4:9021/papss/ -d papss-bridge2-06112024
